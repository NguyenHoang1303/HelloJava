...
import lab1.minvamax.xuLiMinMax;
import lab1.tamgiac.tamgiac;
import lab1.luongnhanvien.tinhluongthuong;
...
public class mainthread {
    ...
    - Hàm tính lương tháng 13 được viết với hai tham số đầu vào là số năm kinh nghiệm và số năm cống hiến.
       * */
            ...
            lab1.luongnhanvien.tinhluongthuong luongthuong = new tinhluongthuong();
            float kingNghiem;
            float congHien;
    ...
    * */
            lab1.tamgiac.tamgiac tamgiac1 = new tamgiac();
...
//         tim so lon nhat va nho nhat trong mang
            lab1.minvamax.xuLiMinMax chuoi = new xuLiMinMax();
